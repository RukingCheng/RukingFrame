...
public class AutoViewGroup extends ViewGroup {
    ...
    public AutoViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AutoViewGroup);
        mDivider = a.getDimensionPixelOffset(R.styleable.AutoViewGroup_metro_divider, 0);
    ...
    @Override
    public AutoViewGroup.LayoutParams generateLayoutParams(AttributeSet attrs) {
