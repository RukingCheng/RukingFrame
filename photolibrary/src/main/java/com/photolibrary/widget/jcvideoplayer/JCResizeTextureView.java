...
public class JCResizeTextureView extends TextureView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        Logger.i(TAG, "onMeasure " + " [" + this.hashCode() + "] ");
        int viewRotation = (int) getRotation();
        int videoWidth = mVideoSize.x;
        int videoHeight = mVideoSize.y;
        Logger.i(TAG, "videoWidth = " + videoWidth + ", " + "videoHeight = " + videoHeight);
        Logger.i(TAG, "viewRotation = " + viewRotation);
        ...
        if (videoWidth > 0 && videoHeight > 0) {
            ...
            Logger.i(TAG, "widthMeasureSpec  [" + MeasureSpec.toString(widthMeasureSpec) + "]");
            Logger.i(TAG, "heightMeasureSpec [" + MeasureSpec.toString(heightMeasureSpec) + "]");
