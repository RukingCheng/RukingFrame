package com.photolibrary.widget.jcvideoplayer;
...
//        findViewById(R.id.menuBut).setOnClickListener(this);
    ...
    public void setUp(String url, int screen, Object... objects) {
        ...
        if (currentScreen == SCREEN_WINDOW_FULLSCREEN) {
            ...
            changeStartButtonSize(AutoUtils.getPercentHeightSizeBigger(122));
        } else if (currentScreen == SCREEN_LAYOUT_NORMAL
                || currentScreen == SCREEN_LAYOUT_LIST) {
            fullscreenButton.setImageResource(R.drawable.jc_enlarge);
            backButton.setVisibility(View.GONE);
            tinyBackImageView.setVisibility(View.INVISIBLE);
            changeStartButtonSize(AutoUtils.getPercentHeightSizeBigger(90));
...
//            }).start();
    ...
    public void updateStartImage() {
        if (currentState == CURRENT_STATE_PLAYING) {
            ...
            startButton.setImageResource(R.drawable.play_btn_select);
        }
    }
    ...
    public void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        ...
        if (mProgressDialog == null) {
            ...
            mProgressDialog = new Dialog(getContext(), R.style.RKAnimationDialogStyle);
        ...
        if (deltaX > 0) {
            mDialogIcon.setImageResource(R.drawable.jc_forward_icon);
        } else {
            mDialogIcon.setImageResource(R.drawable.jc_backward_icon);
        }
    ...
    public void showVolumeDialog(float deltaY, int volumePercent) {
        ...
        if (mVolumeDialog == null) {
            ...
            mVolumeDialog = new Dialog(getContext(), R.style.RKAnimationDialogStyle);
        ...
        if (volumePercent <= 0) {
            mDialogVolumeImageView.setImageResource(R.drawable.jc_close_volume);
        } else {
            mDialogVolumeImageView.setImageResource(R.drawable.jc_add_volume);
        }
    ...
    public void showBrightnessDialog(int brightnessPercent) {
        ...
        if (mBrightnessDialog == null) {
            ...
            mBrightnessDialog = new Dialog(getContext(), R.style.RKAnimationDialogStyle);
