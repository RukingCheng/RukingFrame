...
public class CircleProgressView extends ProgressBar {
    ...
    private int mReachBarSize = AutoUtils.getPercentWidthSizeBigger(4); // 未完成进度条大小
    private int mNormalBarSize = AutoUtils.getPercentWidthSizeBigger(4); // 未完成进度条大小
    private int mReachBarColor = Color.parseColor("#108ee9"); // 已完成进度颜色
    private int mNormalBarColor = Color.parseColor("#FFD3D6DA"); // 未完成进度颜色
    private int mTextSize = AutoUtils.getPercentWidthSizeBigger(28); // 进度值字体大小
    ...
    private int mRadius = AutoUtils.getPercentWidthSizeBigger(40); // 半径
    private int mStartArc; // 起始角度
    private int mInnerBackgroundColor; // 内部背景填充颜色
    private int mProgressStyle = ProgressStyle.NORMAL; // 进度风格
    private int mInnerPadding = AutoUtils.getPercentWidthSizeBigger(2); // 内部圆与外部圆间距
    ...
    private int mOuterSize = AutoUtils.getPercentWidthSizeBigger(2); // 外层圆环宽度
    ...
    public void setReachBarSize(int reachBarSize) {
        mReachBarSize = AutoUtils.getPercentWidthSizeBigger(reachBarSize);
        invalidate();
    }
    ...
    public void setNormalBarSize(int normalBarSize) {
        mNormalBarSize = AutoUtils.getPercentWidthSizeBigger(normalBarSize);
        invalidate();
    }
    ...
    public void setTextSize(int textSize) {
        mTextSize = AutoUtils.getPercentWidthSizeBigger(textSize);
        invalidate();
    }
    ...
    public void setRadius(int radius) {
        mRadius = AutoUtils.getPercentWidthSizeBigger(radius);
        invalidate();
    }
    ...
    public void setInnerPadding(int innerPadding) {
        mInnerPadding = AutoUtils.getPercentWidthSizeBigger(innerPadding);
        int mInnerRadius = mRadius - mOuterSize / 2 - mInnerPadding;
        rectInner = new RectF(-mInnerRadius, -mInnerRadius, mInnerRadius, mInnerRadius);
        invalidate();
    }
    ...
    public void setOuterSize(int outerSize) {
        mOuterSize = AutoUtils.getPercentWidthSizeBigger(outerSize);
        invalidate();
    }
