 ...
 */
public class RKAnimationLinearLayout extends AutoLinearLayout {
    private RKViewAnimationBase mRKViewAnimationBase;

    public RKAnimationLinearLayout(Context context) {
        super(context);
        init(null);
    }

    public RKAnimationLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }
