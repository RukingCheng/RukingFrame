...
public class RKElasticViewPager extends ViewPager {
    ...
    public RKElasticViewPager(Context context) {
        super(context);
    }

    public RKElasticViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
